...
switch (Integer.parseInt(numero)){
	...
	case 2:
		...
		break;
	case 3:
		modificaObjeto(hostname, dbname, "Alejandro", 911000011);
	...
	public static void creaObjetos(String hostname, String dbname) {
		try {
			...
			db.open();
			db.startTransaction();
			System.out.println("Conectado a la base de datos " + db.toString() + " Matisse");
			// Crea un objeto Profesor
			Profesor a1 = new Profesor(db);
			a1.setNombre("Alejandro");
			a1.setApellidos("Polinario");
			a1.setDni("29511125D");
